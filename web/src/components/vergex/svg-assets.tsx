import naturalIcon from '../../../public/vergex/vergex/natural-language-icon.png'
...
export const NaturalLanguageIcon = () => (
  <img width="64" height="64" src={naturalIcon} alt="Natural Language Icon" />
)
...
export const VergeXTriangle = () => (
  ...
  >
    <rect
      ...
      height="40"
      rx="8"
      fill="url(#paint0_linear_vx)"
      transform="rotate(45 20 20)"
    />
    <path
      d="M20 10L10 30H30L20 10Z"
      fill="white"
      transform="rotate(45 20 20)"
    />
    <defs>
...
export const GithubIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M50 10C27.9086 10 10 28.3198 10 50.9091C10 69.0309 21.8629 84.4309 38.4357 90C40.6429 90.4091 41.4286 89.0436 41.4286 87.8836V80.6836C28.9214 83.4109 26.2857 75.0164 26.2857 75.0164C24.2857 69.9854 21.2857 68.6364 21.2857 68.6364C17.1429 65.7073 21.5714 65.7673 21.5714 65.7673C26.1429 66.0818 28.5 70.5691 28.5 70.5691C32.5714 77.3745 39.2143 75.3509 41.6429 74.2073C42.0714 71.2382 43.2143 69.2182 44.5 68.1145C34.2143 66.9873 23.4286 63.2218 23.4286 46.5564C23.4286 42.0218 25 38.3009 28.5714 35.3982C28.0714 34.2745 26.5 29.5691 29.0714 23.3145C29.0714 23.3145 32.9286 22.1109 41.4286 27.8909C45.0714 26.9018 49 26.4073 52.9286 26.3873C56.8571 26.4073 60.7857 26.9018 64.4286 27.8909C72.9286 22.1109 76.7857 23.3145 76.7857 23.3145C79.3571 29.5691 77.7857 34.2745 77.2857 35.3982C80.8571 38.3009 82.4286 42.0218 82.4286 46.5564C82.4286 63.2618 71.6429 66.9673 61.3571 68.0909C63 69.5364 64.4286 72.3436 64.4286 76.6418V87.8836C64.4286 89.0636 65.2143 90.4291 67.4286 90C84 84.4109 95.8571 69.0109 95.8571 50.9091C95.8571 28.3198 78.0714 10 56 10H50Z"
      fill="white"
    />
  </svg>
)
...
export const ProductsArchitectureDiagram = () => (
  ...
  >
    ...
    <g transform="translate(0, 420)">
      <path
        d="M100 30 L489 30 L544 114 L489 198 L100 198 L45 114 Z"
        fill="rgba(153, 140, 255, 0.15)"
        stroke="rgba(153, 140, 255, 0.4)"
        strokeWidth="1.5"
      />
