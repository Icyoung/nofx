...
export const translations = {
  en: {
    ...
    configureNewTrader: 'Configure new AI trader',
    basicConfiguration: 'Basic Configuration',
    aiModel: 'AI Model',
    exchange: 'Exchange',
    howToDepositHyperLiquid: 'How to deposit to HyperLiquid?',
    tradingConfiguration: 'Trading Configuration',
    marginMode: 'Margin Mode',
    crossMargin: 'Cross',
    isolatedMargin: 'Isolated',
    initialBalanceDollar: 'Initial Balance ($)',
    fetchCurrentBalance: 'Fetch Current Balance',
    fetching: 'Fetching...',
    initialBalanceHint: 'Used to manually update initial balance baseline (e.g., after deposit/withdrawal)',
    autoFetchBalanceHint: 'System will automatically fetch your account equity as initial balance',
    klineIntervals: 'K-line Intervals',
    collapseSelection: 'Collapse',
    quickSelect: 'Quick Select',
    klineIntervalsPlaceholder: 'e.g., 1m,15m,4h (leave empty for system default)',
    clickToSelectKlineIntervals: 'Click to select K-line intervals:',
    klineIntervalsHint: 'Separate multiple intervals with commas, supports 1m,3m,5m,15m,30m,1h,2h,4h,6h,8h,12h,1d,1w',
    ...
    selectPromptTemplateHint: 'Select a preset trading strategy template (includes trading philosophy, risk control principles, etc.)',
    overrideDefaultPrompt: 'Override Default Prompt',
    overrideWarning: 'When enabled, will completely replace default strategy',
    customPromptLabel: 'Custom Prompt',
    additionalPromptLabel: 'Additional Prompt',
    enterFullPromptPlaceholder: 'Enter complete trading strategy prompt...',
    enterAdditionalPromptPlaceholder: 'Enter additional trading strategy hints...',
    saving: 'Saving...',
    saveChanges: 'Save Changes',
    balanceFetchedSuccess: 'Current balance fetched',
    balanceFetchFailed: 'Failed to fetch balance, please check network connection',
    editModeOnlyFetchBalance: 'Can only fetch current balance in edit mode',
    ...
    login: 'Sign In',
    register: 'Sign Up',
    loginNofx: 'Sign in to NOFX',
    enterEmailPassword: 'Enter your email and password',
    enterOtpCodePrompt: 'Enter your two-factor authentication code',
    adminPassword: 'Admin Password',
    adminPasswordPlaceholder: 'Enter admin password',
    showPassword: 'Show password',
    hidePassword: 'Hide password',
    betaCode: 'Beta Code',
    betaCodeRequired: 'Beta code is required during testing period',
    betaCodePlaceholder: 'Enter 6-digit beta code',
    betaCodeHint: '6 alphanumeric characters, case insensitive',
    username: 'Username',
    email: 'Email',
    password: 'Password',
    ...
    resetPasswordSubtitle: 'Reset password using email and Google Authenticator',
    redirectToLoginIn3s: 'Redirecting to login page in 3 seconds...',
    openGoogleAuthenticator: 'Open Google Authenticator to get 6-digit code',
  ...
  zh: {
    ...
    // Trader Config Modal
    editTrader: '修改交易员',
    editTraderConfig: '修改交易员配置参数',
    configureNewTrader: '配置新的AI交易员',
    basicConfiguration: '基础配置',
    aiModel: 'AI模型',
    exchange: '交易所',
    howToDepositHyperLiquid: '如何充值 HyperLiquid?',
    tradingConfiguration: '交易配置',
    marginMode: '保证金模式',
    crossMargin: '全仓',
    isolatedMargin: '逐仓',
    initialBalanceDollar: '初始余额 ($)',
    fetchCurrentBalance: '获取当前余额',
    fetching: '获取中...',
    initialBalanceHint: '用于手动更新初始余额基准（例如充值/提现后）',
    autoFetchBalanceHint: '系统将自动获取您的账户净值作为初始余额',
    klineIntervals: 'K线时间间隔',
    collapseSelection: '收起选择',
    quickSelect: '快速选择',
    klineIntervalsPlaceholder: '例如: 1m,15m,4h (留空使用系统默认)',
    clickToSelectKlineIntervals: '点击选择K线时间间隔：',
    klineIntervalsHint: '用逗号分隔多个时间间隔，支持 1m,3m,5m,15m,30m,1h,2h,4h,6h,8h,12h,1d,1w',
    ...
    selectPromptTemplateHint: '选择预设的交易策略模板（包含交易哲学、风控原则等）',
    overrideDefaultPrompt: '覆盖默认提示词',
    overrideWarning: '启用后将完全替换默认策略',
    customPromptLabel: '自定义提示词',
    additionalPromptLabel: '附加提示词',
    enterFullPromptPlaceholder: '输入完整的交易策略提示词...',
    enterAdditionalPromptPlaceholder: '输入额外的交易策略提示...',
    saving: '保存中...',
    saveChanges: '保存修改',
    balanceFetchedSuccess: '已获取当前余额',
    balanceFetchFailed: '获取余额失败，请检查网络连接',
    editModeOnlyFetchBalance: '只有在编辑模式下才能获取当前余额',
    ...
    betaCodeHint: '内测码由6位字母数字组成，不区分大小写',
    username: '用户名',
    email: '邮箱',
    password: '密码',
    ...
    resetPasswordSubtitle: '使用邮箱和 Google Authenticator 重置密码',
    redirectToLoginIn3s: '3秒后将自动跳转到登录页面...',
    openGoogleAuthenticator: '打开 Google Authenticator 获取6位验证码',
