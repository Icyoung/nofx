...
export const translations = {
  en: {
    ...
    klineIntervalsPlaceholder:
      'e.g., 1m,15m,4h (leave empty for system default)',
    clickToSelectKlineIntervals: 'Click to select K-line intervals:',
    klineIntervalsHint:
      'Separate multiple intervals with commas, supports 1m,3m,5m,15m,30m,1h,2h,4h,6h,8h,12h,1d,1w',
    ...
    enterAdditionalPromptPlaceholder:
      'Enter additional trading strategy hints...',
    saving: 'Saving...',
    ...
    loginErrorHelp:
      'If you just registered, please wait a few seconds and try again.',
    weak: 'Weak',
    medium: 'Medium',
    strong: 'Strong',
  ...
  zh: {
    ...
    invalidCredentials: '邮箱或密码错误，请检查您的账户信息。',
    networkError: '网络错误，请检查您的网络连接后重试。',
    serverError: '服务器错误，请稍后重试。',
    loginErrorHelp: '如果您刚刚注册，请稍等几秒后再试。',
    weak: '弱',
    medium: '中',
    strong: '强',
